function Diploma() {
    return (
        <div className="DiplomaData">

            <div className="container-fluid row  text-center p-0  py-2  myshadow" style={{ background: 'white', marginTop: '4rem' }}
                id="mainDiplomaContainer">
                <div className="col-md-12">
                    <h1 className="fw-bolder">All <font color="red"> Diploma Course </font>
                    </h1>
                    <small className="d-flex px-2"> <a href="index.html" className="nav-link"><i className="fa fa-home"> </i> / </a> &nbsp; Diploma
                        Courses </small>
                </div>
            </div>


            <div className=" mx-md-5 mx-1 mb-2 " style={{ background: 'white' }} id="mainContainer">
                <div className="diplomaTable pb-3">
                    <div className="container-fluid" data-aos="fade-down">

                        <table className="table table-hover table-bordered border-primary  
               table-lg table-hover" style={{ border: '1px solid skyblue' }}>
                            <tr className="headText">
                                <th colspan="5"> ADCA<sup className="transparentTableData m-0 p-0 text-white">+</sup> ( Advance Diploma in Computer Application) </th>
                            </tr>
                    ...
                    <div className="container-fluid my-4 " data-aos="fade-down">
                        <table className="table table-bordered border-primary  table-lg table-hover" style={{ border: '1px solid skyblue' }}>
                            ...
                            <tr>
                                ...
                                <td id="DbiTextSix" className="transparentTableData">Realationship buinding & team management </td>
                            ...
                            <tr>
                                ...
                                <td id="DbiTextTwelv" className="transparentTableData">Downloading perodic account statement </td>
                            </tr>
                            <tr>
                    ...
                    <div className="container-fluid  my-4 " data-aos="fade-down">
                        <table className="table table-bordered border-primary  table-lg table-hover" style={{ border: '1px solid skyblue' }}>
                            ...
                            <tr>
                                ...
                                <td id="CacTextTwo" className="transparentTableData">Tally with inventory & taxation with GST </td>
                            </tr>
                        </table>
                    </div>
                    <div className="container-fluid  my-4" data-aos="fade-down">
